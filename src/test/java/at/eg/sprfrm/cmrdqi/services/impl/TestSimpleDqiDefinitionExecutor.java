...
public class TestSimpleDqiDefinitionExecutor {
	...
	public void runDqiDefinitionWithError() throws InterruptedException, ExecutionException, TimeoutException {
		...
		assertEquals("There should be 1 and only 1 Execution record in the table. Please check what was generated for this test and also have a look at the filter from query."
				,1,list.size());
	...
	@Test
	@Transactional(propagation=Propagation.REQUIRES_NEW)
	public void runDqiDefinitionWithExceptionFromParameter() throws InterruptedException, ExecutionException, TimeoutException {
		
		log.info("Starting test ...");
		DqiRequest request=factoryObject.getAsReferenceTestRequest();
		DqiDefinition definition=factoryObject.getAsReferenceTestDefintionByIndex(4);
